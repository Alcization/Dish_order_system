...
(5, 3, 3, '789 Elm St, Someplace USA', 80000, '2023-07-20'),
...
(10, 3, 8, '753 Elm Ave, Nowhere USA', 70000, '2023-12-01'),
(11, 2, 9, '258 Maple Dr, Everytown USA', 150000, '2024-01-05'),
(12, 3, 10, '456 Pine St, Anotherton USA', 110000, '2024-02-10');
...
INSERT INTO `create_order` (`order_id`, `food_id`, `quantity`, `temp_price`, `create_date`) 
VALUES
...
(8, 14, 1, 150000, '2025-06-01'),  
(9, 12, 2, 300000, '2025-06-10'),  
(10, 11, 1, 120000, '2025-06-15'); 
